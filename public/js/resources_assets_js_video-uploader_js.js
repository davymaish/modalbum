(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_assets_js_video-uploader_js"],{

/***/ "./resources/assets/js/video-uploader.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/video-uploader.js ***!
  \***********************************************/
...
+function ($) {
  ...
  var btn_v_upload = $('#btn_video_uploader');
  var btn_v_upload_disable = function btn_v_upload_disable() {
  ...
  var btn_v_upload_enable = function btn_v_upload_enable() {
    if (btn_v_upload.prop('disabled')) {
      $('.save-spinner').remove();
  ...
  var vuploader = $('#video_uploader').fineUploader({
    ...
    callbacks: {
      ...
      onComplete: function onComplete(id, name, response) {
        if (response.success) {
          ...
          $('.error-msg').text('');
          var fileEl = vuploader.fineUploader("getItemByFileId", id),
  ...
  btn_v_upload.click(function (e) {
    var title = $("#form_upload input[name='title']").val();
    var description = $("#form_upload textarea[name='description']").val();
    if (title == "" || description == "") {
      swal('Error!', 'Video Title and Description are required!', 'error');
    } else {
