(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_assets_js_image-uploader_js"],{

/***/ "./resources/assets/js/image-uploader.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/image-uploader.js ***!
  \***********************************************/
...
/* harmony import */ var fine_uploader_lib_jquery_traditional__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! fine-uploader/lib/jquery/traditional */ "./node_modules/fine-uploader/lib/jquery/traditional.js");
/* harmony import */ var fine_uploader_lib_jquery_traditional__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(fine_uploader_lib_jquery_traditional__WEBPACK_IMPORTED_MODULE_0__);
...
+function ($) {
  ...
  var btn_i_upload = $('#btn_image_uploader');
  var btn_i_upload_disable = function btn_i_upload_disable() {
  ...
  var btn_i_upload_enable = function btn_i_upload_enable() {
    if (btn_i_upload.prop('disabled')) {
      $('.save-spinner').remove();
  ...
  var iuploader = $('#image_uploader').fineUploader({
    ...
    callbacks: {
      onError: function onError(id, name, errorReason) {
        var fileEl = iuploader.fineUploader("getItemByFileId", id);
        fileEl.find('.upload-error').removeClass('hidden').find('.error-msg').text('Error: ' + errorReason);
        btn_i_upload_enable();
      },
      ...
      onAllComplete: function onAllComplete(s, f) {
        if (s.length > 0) {
          $('#form_upload').submit();
        }
      }
  ...
  $('.btn_delete_album, .btn_delete_image').click(function (e) {
    ...
    var delete_type = 'Album';
    var data_id = album_id;
    var delete_url = BASEURL + '/my/album/delete';
    if (!isNaN(image_id)) {
      delete_type = 'Image';
      data_id = image_id;
      delete_url = BASEURL + '/my/image/delete';
    }
    new swal({
      ...
      new swal(delete_type + " Deleted!", delete_type + " deleted successfully.", "success");
    }, function () {
      swal.resetDefaults();
    });
    e.preventDefault();
...
/***/ "./node_modules/fine-uploader/lib/jquery/traditional.js":
/*!**************************************************************!*\
  !*** ./node_modules/fine-uploader/lib/jquery/traditional.js ***!
  \**************************************************************/
...
module.exports = __webpack_require__(/*! ../../jquery.fine-uploader/jquery.fine-uploader */ "./node_modules/fine-uploader/jquery.fine-uploader/jquery.fine-uploader.js");
